...
namespace GTech.Olivia.Gyzer
{
	public class HttpHelper
	{
        ...
        string cUserAgent = "Mozilla/5.0 (Windows; U; MSIE 9.0; Windows NT 9.0; en-US)";
		...
		public void DownloadFileEv(string url, string referrer, string filePath)
		{
            ...
            {
                oArgs.StatusCode = HttpStatusCode.ServiceUnavailable;
                oArgs.Done = false;

                oArgs.Error = true;
                oArgs.ErrorMsg = ex.Message;
                this.OnReceiveData(this, oArgs);
            }
