...
//                               (HMENU)ID_TEXTMSG,                         // the ID of your editbox
//                               hwnd,                                // the instance of your application
//                               NULL
//                            );  
	   		break;
	   	}
		...
		case WM_PAINT:			{
			...
			bitmap=(HBITMAP)LoadImage(NULL,".\\usblock.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
			HDC hMemDC=CreateCompatibleDC(hdc); 
			::SelectObject(hMemDC,bitmap);           
			BitBlt(hdc,5,20,200,400,hMemDC,0,0,SRCCOPY); 
			::DeleteDC(hMemDC) ;    
